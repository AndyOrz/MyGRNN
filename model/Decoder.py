...
from .DyGCGRUCell import DyGCGRUCell as GRUCell


class Decoder(nn.Module):
    def __init__(self, hidden_size:int, output_size:int, num_layers:int, proj:bool=True, proj_settings={} ,**kwargs):
        """
    ...
    def forward(self, input, hx):
        ...
        for i, gru in enumerate(self.GRUs):
            next_hidden_state = gru(output, hx[i])
